      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          ...
          <button onClick={onSignup}
            className="flex items-center gap-2 px-8 py-4 bg-gray-900 border border-gray-700 hover:border-indigo-500 text-white font-bold text-lg rounded-2xl transition-all w-full sm:w-auto justify-center">
            <Shield className="w-5 h-5 text-indigo-400" />
            Start Free Trial
          </button>
        </div>
        <p className="text-center text-xs text-gray-600 mt-4">No credit card required • 10-day free trial • Full access</p>
      </motion.div>
    </div>
  );
}
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <div className="bg-white dark:bg-gray-900 rounded-3xl border border-gray-200 dark:border-gray-700 shadow-2xl p-8 text-center max-w-sm">
                      ...
                      <p className="text-sm text-gray-500 mb-5">
                        This section is available to registered users only. Sign up for a free 10-day trial to access all features.
                      </p>
                      <button onClick={onSignup} className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-2xl transition-colors">
                        Start Free Trial →
                      </button>
                    </div>
                  </div>
