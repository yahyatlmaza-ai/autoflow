            ...
            {user ? (
              ...
              <>
                ...
                <button onClick={() => navigate('/signup')}
                  className="px-5 py-2.5 bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 text-white text-sm font-bold rounded-xl transition-all shadow-lg hover:shadow-indigo-500/30 hover:-translate-y-0.5">
                  {t(lang, 'nav_trial')}
                </button>
              </>
            )}
          ...
          <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }}
            ...
            <div className="px-4 py-4 space-y-1">
              ...
              <div className="pt-3 space-y-2">
                ...
                <button onClick={() => navigate('/signup')} className="w-full px-4 py-3 text-sm font-bold text-center bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-xl">{t(lang, 'nav_trial')}</button>
              </div>
